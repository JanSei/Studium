...
abstract class BinOpNode implements Node {
	...
	/**
	 * Erzeugt die Darstellung fuer eine binaere Operation. Der String lautet:
	 * 
	 * <pre>
	 *     ( linke-Seite Operator rechte-Seite )
	 * </pre>
	 * 
	 * Der Operator ist +,-,*,/ linke/rechte Seite sind die Stringdarstellung
	 * des jeweiligen Teilbaums.
	 * 
