package gui;
import finance.FinancialHistory;
...
public class Application extends JFrame {
    ...
    private LabeledItemPanel income() {
        LabeledItemPanel p = new LabeledItemPanel();
    ...
    private LabeledItemPanel expenditures() {
        LabeledItemPanel p = new LabeledItemPanel();
    ...
    private LabeledItemPanel cash() {
        LabeledItemPanel p = new LabeledItemPanel();
        p.addItem("Money on hand: ", cashOnHand);
        return p;
    }
        
    private JComponent recallTotals() {
