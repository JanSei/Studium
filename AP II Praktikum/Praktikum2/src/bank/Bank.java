...
public final class Bank {
    ...
    public int neuesKonto() {
        ...
        konten.add(new Konto(name + ": " + kontoNr)); // wir haben eine 'add'-Methode, also waere sinnvoll die auch zu verwenden! 
        anzahlKonten++;		// die Anzahl der Konten muessen pro Eintrag hochgezaehlt werden
        return kontoNr;
    }
