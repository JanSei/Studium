...
public class MainSearch {
	...
	public static void main(String[] args) {
		...
		int meinIndexBinär = BinäreSuche.binarySearch(meinDeck.getDeck().toArray(new PlayingCard[0]), new PlayingCard(4, "♥"), new Comparator<PlayingCard>() {
			@Override
			public int compare(PlayingCard o1, PlayingCard o2) {
			return (int) Math.signum(o1.getValue() - o2.getValue());
			}
			});
		System.out.println(meinIndexBinär);
	}
